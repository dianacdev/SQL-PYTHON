...
CREATE TABLE `customer_audit` (
  `employee_audit_id` int unsigned NOT NULL AUTO_INCREMENT,
  `employee_id` int unsigned DEFAULT NULL,
  `change_on` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`employee_audit_id`),
  KEY `employee_id` (`employee_id`),
  CONSTRAINT `customer_audit_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `customer` (`employee_id`)
...
-- Dump completed on 2023-12-01  1:07:11
